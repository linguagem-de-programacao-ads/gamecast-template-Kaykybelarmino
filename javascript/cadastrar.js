    ...
    async function cadastrarAgenda(){
        ...
        const descricaoDigitada = document.getElementById("descricao_jogo").value;
        ...
        const respostaCadastro = await fetch("https://660f44ae356b87a55c510d34.mockapi.io/agendas", {
            method: "POST",
